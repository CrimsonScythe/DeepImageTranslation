    ...
    for i, batch in islice(zip(dataloader, dataloader2),80, 81, None):
      #  
        ...
        with torch.enable_grad():
          ...
          Normalize?
          '''
          # gt_B = (2*((gt_B - torch.min(gt_B))/(torch.max(gt_B)-torch.min(gt_B))))-1


          '''
          ??Transform gt labels to have 5 dimensions. Onehot. 
          '''
          gt_B=gt_B.detach().cpu()
          gt_B=gt_B.numpy()
          np_tensor=gt_B
          ...
          gt_B=torch.from_numpy(inter.numpy())
          gt_B=gt_B.permute(2,0,1)
          gt_B=gt_B.unsqueeze(0)
          gt_B=gt_B.to('cuda')
          gt_B.requires_grad=True
          
          # TODO uint8 in tf code
          # gt_B=gt_B.detach()
          # torch.set_printoptions(threshold=10_000)
          # y=torch.squeeze(gt_B).type(torch.uint8)
          # print(y)
          ...
          # vis(y)
          # print(torch.unique(y))
          # gt_B=F.one_hot(torch.squeeze(gt_B).type(torch.LongTensor), num_classes=5)
          ...
          # ce_loss_b, dice_loss_b = task_loss(pred_mask_fake_b, gt_B)
          ...
          ce_loss_b, dice_loss_b = task_loss(pred_mask_fake_b, gt_B)
          # loss = nn.MSELoss()
          # gt_B=gt_B.to(torch.float)
          # ce_loss_b = loss(pred_mask_fake_b, gt_B)
          
          ce_loss_b_II, dice_loss_b_II = task_loss(pred_mask_fake_b_II, gt_B)
          l2_loss_b = l2_loss()
          ...
          # vis(cycle_imgs_a)
        if epoch%1000==0:
          with open('/zhome/0d/7/157010/results2/fakeb'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(fake_imgs_b, f)
          with open('/zhome/0d/7/157010/results2/fakea'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(fake_imgs_a, f)
          with open('/zhome/0d/7/157010/results2/cyclea'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(cycle_imgs_a, f)
          with open('/zhome/0d/7/157010/results2/cycleb'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(cycle_imgs_b, f)
          with open('/zhome/0d/7/157010/results2/pred_mask_fake_b'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(pred_mask_fake_b, f)
          with open('/zhome/0d/7/157010/results2/pred_mask_fake_b_II'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(pred_mask_fake_b_II, f)
          with open('/zhome/0d/7/157010/results2/pred_mask_b'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(pred_mask_b, f)
          with open('/zhome/0d/7/157010/results2/pred_mask_b_II'+str(epoch)+'.pickle', 'wb') as f:
        ...
        with torch.no_grad():
          ...
          '''
          '''
          TODO SETTING ENCODER 
          '''
          Encoder.out_c1.batchnorm.eval()
          Encoder.out_c2.batchnorm.eval()
          Encoder.out_c3.batchnorm.eval()
          ...
          if epoch%1000==0:
            with open('/zhome/0d/7/157010/results2/evalfakeb'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(fake_imgs_b, f)
            with open('/zhome/0d/7/157010/results2/evalfakea'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(fake_imgs_a, f)
            with open('/zhome/0d/7/157010/results2/evalcyclea'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(cycle_imgs_a, f)
            with open('/zhome/0d/7/157010/results2/evalcycleb'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(cycle_imgs_b, f)
            with open('/zhome/0d/7/157010/results2/evalpred_mask_fake_b'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(pred_mask_fake_b, f)
            with open('/zhome/0d/7/157010/results2/evalpred_mask_fake_b_II'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(pred_mask_fake_b_II, f)
            with open('/zhome/0d/7/157010/results2/evalpred_mask_b'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(pred_mask_b, f)
            with open('/zhome/0d/7/157010/results2/evalpred_mask_b_II'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(pred_mask_b_II, f)


import pandas as pd
df = pd.DataFrame(data, columns=['time', 'epoch', 'g_a loss', 'g_b loss', 
'd_a loss', 'd_b loss', 'seg loss', 'd_p loss', 'd_p_II loss', 'dice_b loss', 'dice_b_II loss',
'ce_loss_b', 'ce_loss_b_II'])
df.to_csv('/zhome/0d/7/157010/results2/data.csv')

with open('/zhome/0d/7/157010/results2/fakebfinal.pickle', 'wb') as f:
  pickle.dump(fake_imgs_b, f)
with open('/zhome/0d/7/157010/results2/fakeafinal.pickle', 'wb') as f:
  pickle.dump(fake_imgs_a, f)
with open('/zhome/0d/7/157010/results2/cyclebfinal.pickle', 'wb') as f:
  pickle.dump(cycle_imgs_b, f)
with open('/zhome/0d/7/157010/results2/cycleafinal.pickle', 'wb') as f:
  pickle.dump(cycle_imgs_a, f)
with open('/zhome/0d/7/157010/results2/pred_mask_fake_bfinal.pickle', 'wb') as f:
  pickle.dump(pred_mask_fake_b, f)
with open('/zhome/0d/7/157010/results2/pred_mask_fake_b_IIfinal.pickle', 'wb') as f:
  pickle.dump(pred_mask_fake_b_II, f)
with open('/zhome/0d/7/157010/results2/pred_mask_bfinal.pickle', 'wb') as f:
  pickle.dump(pred_mask_b, f)
with open('/zhome/0d/7/157010/results2/pred_mask_b_IIfinal.pickle', 'wb') as f:
  pickle.dump(pred_mask_b_II, f)
