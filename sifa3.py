...
DIR='/zhome/0d/7/157010/results2'
...
opt={"lr":0.0002,"b1":0.5, "b2":0.999, "epoch":0, "n_epochs":20000}
...
for epoch in range(opt["n_epochs"]):
    for i, batch in islice(zip(dataloader, dataloader2),80, 81, None):
        ...
        if epoch%1000==0:
          with open(f'{DIR}/fakeb'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(fake_imgs_b, f)
          with open(f'{DIR}/fakea'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(fake_imgs_a, f)
          with open(f'{DIR}/cyclea'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(cycle_imgs_a, f)
          with open(f'{DIR}/cycleb'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(cycle_imgs_b, f)
          with open(f'{DIR}/pred_mask_fake_b'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(pred_mask_fake_b, f)
          with open(f'{DIR}/pred_mask_fake_b_II'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(pred_mask_fake_b_II, f)
          with open(f'{DIR}/pred_mask_b'+str(epoch)+'.pickle', 'wb') as f:
            pickle.dump(pred_mask_b, f)
          with open(f'{DIR}/pred_mask_b_II'+str(epoch)+'.pickle', 'wb') as f:
        ...
        with torch.no_grad():
          ...
          '''
          Staying true to the SIFA code, setting batchnorm layers in teh Encoder only to eval mode
          '''
          ...
          if epoch%1000==0:
            with open(f'{DIR}/evalfakeb'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(fake_imgs_b, f)
            with open(f'{DIR}/evalfakea'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(fake_imgs_a, f)
            with open(f'{DIR}/evalcyclea'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(cycle_imgs_a, f)
            with open(f'{DIR}/evalcycleb'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(cycle_imgs_b, f)
            with open(f'{DIR}/evalpred_mask_fake_b'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(pred_mask_fake_b, f)
            with open(f'{DIR}/evalpred_mask_fake_b_II'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(pred_mask_fake_b_II, f)
            with open(f'{DIR}/evalpred_mask_b'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(pred_mask_b, f)
            with open(f'{DIR}/evalpred_mask_b_II'+str(epoch)+'.pickle', 'wb') as f:
              pickle.dump(pred_mask_b_II, f)
